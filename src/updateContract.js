...
function updateContract(appIndex, propertyNumber, propertySold, meetSalesCondition, postDeadlineCheck) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        atc.addMethodCall({
            ...
            appID: appIndex,
            method: algosdk_1.default.getMethodByName(contract.methods, 'updateSenderFundsItem'),
